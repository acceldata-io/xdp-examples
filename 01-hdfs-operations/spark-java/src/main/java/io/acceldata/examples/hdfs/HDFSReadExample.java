...
public class HDFSReadExample {
    ...
    public static void main(String[] args) {
        String hdfsPath = args.length > 0 ? args[0] : System.getenv().getOrDefault("HDFS_PATH", "hdfs://namenode1:8020/user/nitin-upadhyaya/");
    ...
    private static void configureHadoopForContainer(SparkSession spark) {
        try {
            ...
            String fsDefault = System.getenv().getOrDefault("FS_DEFAULT", "hdfs://namenode1:8020");
    ...
    private static void configureKerberosAuthentication(Configuration hadoopConf) throws IOException {
        ...
        String keytabPath = System.getenv().getOrDefault("KERBEROS_KEYTAB", "/etc/hdfs.headless.keytab");
